#############################################################################
# Makefile for building: dist/Release/GNU_stat-Linux-x86/SOURCE
# Generated by qmake (2.01a) (Qt 4.7.4) on: Tue Sep 20 08:08:27 2011
...
TARGET        = dist/Release/GNU_stat-Linux-x86/SOURCE
...
dist: 
	@$(CHK_DIR_EXISTS) build/Release/GNU_stat-Linux-x86/SOURCE1.0.0 || $(MKDIR) build/Release/GNU_stat-Linux-x86/SOURCE1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/Release/GNU_stat-Linux-x86/SOURCE1.0.0/ && $(COPY_FILE) --parents controller.h MessageEditor.h Receive.h Transmit.h cannet.h msg.h canlistener.h Connection.h MainWindow.h canio.h build/Release/GNU_stat-Linux-x86/SOURCE1.0.0/ && $(COPY_FILE) --parents MainWindow.cpp Connection.cpp canio.cpp cannet.cpp main.cpp msg.cpp Receive.cpp controller.cpp Transmit.cpp MessageEditor.cpp build/Release/GNU_stat-Linux-x86/SOURCE1.0.0/ && (cd `dirname build/Release/GNU_stat-Linux-x86/SOURCE1.0.0` && $(TAR) SOURCE1.0.0.tar SOURCE1.0.0 && $(COMPRESS) SOURCE1.0.0.tar) && $(MOVE) `dirname build/Release/GNU_stat-Linux-x86/SOURCE1.0.0`/SOURCE1.0.0.tar.gz . && $(DEL_FILE) -r build/Release/GNU_stat-Linux-x86/SOURCE1.0.0
